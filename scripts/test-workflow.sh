...
rg -Fq '    tags:' "$flutter_gitee_workflow"
rg -Fq '    tags:' "$ROOT_DIR/.workflow/流水线-202608021802.yml"
! rg -Fq '    branches:' "$flutter_gitee_workflow"
! rg -Fq '    branches:' "$ROOT_DIR/.workflow/流水线-202608021802.yml"
rg -Fq '      - v' "$flutter_gitee_workflow"
rg -Fq '      - v' "$ROOT_DIR/.workflow/流水线-202608021802.yml"
...
node "$ROOT_DIR/scripts/test-ci-pub.cjs"
