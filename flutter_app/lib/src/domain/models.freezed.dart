...
mixin _$ServerProfile {
 ...
 String get id; String get name; String get host; int get port; String get username; AuthMode get authMode; String get password; String get privateKeyPem; String get privateKeyPassphrase; String get hostFingerprint; String get workspace; String get proxyUrl; ApprovalMode get approvalMode; String get remoteCommand; String get codexVersion; bool get workspacePromptShown; String get preferredModel; String get preferredEffort; String get testModel; List<CustomModelDefinition> get customModels; List<String> get hiddenModelIds;@Deprecated('Kept only for profiles written by older app versions.') AgentMode get agentMode; AgentKind get activeAgent; Map<AgentKind, AgentModelSettings> get agentModelSettings;
...
@useResult
$Res call({
 String id, String name, String host, int port, String username, AuthMode authMode, String password, String privateKeyPem, String privateKeyPassphrase, String hostFingerprint, String workspace, String proxyUrl, ApprovalMode approvalMode, String remoteCommand, String codexVersion, bool workspacePromptShown, String preferredModel, String preferredEffort, String testModel, List<CustomModelDefinition> customModels, List<String> hiddenModelIds,@Deprecated('Kept only for profiles written by older app versions.') AgentMode agentMode, AgentKind activeAgent, Map<AgentKind, AgentModelSettings> agentModelSettings
});
...
as String,codexVersion: null == codexVersion ? _self.codexVersion : codexVersion // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  String host,  int port,  String username,  AuthMode authMode,  String password,  String privateKeyPem,  String privateKeyPassphrase,  String hostFingerprint,  String workspace,  String proxyUrl,  ApprovalMode approvalMode,  String remoteCommand,  String codexVersion,  bool workspacePromptShown,  String preferredModel,  String preferredEffort,  String testModel,  List<CustomModelDefinition> customModels,  List<String> hiddenModelIds, @Deprecated('Kept only for profiles written by older app versions.')  AgentMode agentMode,  AgentKind activeAgent,  Map<AgentKind, AgentModelSettings> agentModelSettings)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ServerProfile() when $default != null:
return $default(_that.id,_that.name,_that.host,_that.port,_that.username,_that.authMode,_that.password,_that.privateKeyPem,_that.privateKeyPassphrase,_that.hostFingerprint,_that.workspace,_that.proxyUrl,_that.approvalMode,_that.remoteCommand,_that.codexVersion,_that.workspacePromptShown,_that.preferredModel,_that.preferredEffort,_that.testModel,_that.customModels,_that.hiddenModelIds,_that.agentMode,_that.activeAgent,_that.agentModelSettings);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  String host,  int port,  String username,  AuthMode authMode,  String password,  String privateKeyPem,  String privateKeyPassphrase,  String hostFingerprint,  String workspace,  String proxyUrl,  ApprovalMode approvalMode,  String remoteCommand,  String codexVersion,  bool workspacePromptShown,  String preferredModel,  String preferredEffort,  String testModel,  List<CustomModelDefinition> customModels,  List<String> hiddenModelIds, @Deprecated('Kept only for profiles written by older app versions.')  AgentMode agentMode,  AgentKind activeAgent,  Map<AgentKind, AgentModelSettings> agentModelSettings)  $default,) {final _that = this;
switch (_that) {
case _ServerProfile():
return $default(_that.id,_that.name,_that.host,_that.port,_that.username,_that.authMode,_that.password,_that.privateKeyPem,_that.privateKeyPassphrase,_that.hostFingerprint,_that.workspace,_that.proxyUrl,_that.approvalMode,_that.remoteCommand,_that.codexVersion,_that.workspacePromptShown,_that.preferredModel,_that.preferredEffort,_that.testModel,_that.customModels,_that.hiddenModelIds,_that.agentMode,_that.activeAgent,_that.agentModelSettings);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name,  String host,  int port,  String username,  AuthMode authMode,  String password,  String privateKeyPem,  String privateKeyPassphrase,  String hostFingerprint,  String workspace,  String proxyUrl,  ApprovalMode approvalMode,  String remoteCommand,  String codexVersion,  bool workspacePromptShown,  String preferredModel,  String preferredEffort,  String testModel,  List<CustomModelDefinition> customModels,  List<String> hiddenModelIds, @Deprecated('Kept only for profiles written by older app versions.')  AgentMode agentMode,  AgentKind activeAgent,  Map<AgentKind, AgentModelSettings> agentModelSettings)?  $default,) {final _that = this;
switch (_that) {
case _ServerProfile() when $default != null:
return $default(_that.id,_that.name,_that.host,_that.port,_that.username,_that.authMode,_that.password,_that.privateKeyPem,_that.privateKeyPassphrase,_that.hostFingerprint,_that.workspace,_that.proxyUrl,_that.approvalMode,_that.remoteCommand,_that.codexVersion,_that.workspacePromptShown,_that.preferredModel,_that.preferredEffort,_that.testModel,_that.customModels,_that.hiddenModelIds,_that.agentMode,_that.activeAgent,_that.agentModelSettings);case _:
  return null;
...
@override@JsonKey() final  String codexVersion;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,name,host,port,username,authMode,password,privateKeyPem,privateKeyPassphrase,hostFingerprint,workspace,proxyUrl,approvalMode,remoteCommand,codexVersion,workspacePromptShown,preferredModel,preferredEffort,testModel,const DeepCollectionEquality().hash(_customModels),const DeepCollectionEquality().hash(_hiddenModelIds),agentMode,activeAgent,const DeepCollectionEquality().hash(_agentModelSettings)]);
...
mixin _$AgentSetupState {
 ...
 RemoteSetupPrompt? get prompt; bool get inProgress; String get progress; int get percent; String get detail; int? get downloadPercent; int? get downloadedBytes; int? get totalBytes; int? get bytesPerSecond; int? get elapsedSeconds; bool get progressIndeterminate; bool get minimized;
...
@useResult
$Res call({
 RemoteSetupPrompt? prompt, bool inProgress, String progress, int percent, String detail, int? downloadPercent, int? downloadedBytes, int? totalBytes, int? bytesPerSecond, int? elapsedSeconds, bool progressIndeterminate, bool minimized
});
...
/// Create a copy of AgentSetupState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? prompt = freezed,Object? inProgress = null,Object? progress = null,Object? percent = null,Object? detail = null,Object? downloadPercent = freezed,Object? downloadedBytes = freezed,Object? totalBytes = freezed,Object? bytesPerSecond = freezed,Object? elapsedSeconds = freezed,Object? progressIndeterminate = null,Object? minimized = null,}) {
  return _then(_self.copyWith(
...
as int?,progressIndeterminate: null == progressIndeterminate ? _self.progressIndeterminate : progressIndeterminate // ignore: cast_nullable_to_non_nullable
as bool,minimized: null == minimized ? _self.minimized : minimized // ignore: cast_nullable_to_non_nullable
as bool,
  ));
}
/// Create a copy of AgentSetupState
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( RemoteSetupPrompt? prompt,  bool inProgress,  String progress,  int percent,  String detail,  int? downloadPercent,  int? downloadedBytes,  int? totalBytes,  int? bytesPerSecond,  int? elapsedSeconds,  bool progressIndeterminate,  bool minimized)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AgentSetupState() when $default != null:
return $default(_that.prompt,_that.inProgress,_that.progress,_that.percent,_that.detail,_that.downloadPercent,_that.downloadedBytes,_that.totalBytes,_that.bytesPerSecond,_that.elapsedSeconds,_that.progressIndeterminate,_that.minimized);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( RemoteSetupPrompt? prompt,  bool inProgress,  String progress,  int percent,  String detail,  int? downloadPercent,  int? downloadedBytes,  int? totalBytes,  int? bytesPerSecond,  int? elapsedSeconds,  bool progressIndeterminate,  bool minimized)  $default,) {final _that = this;
switch (_that) {
case _AgentSetupState():
return $default(_that.prompt,_that.inProgress,_that.progress,_that.percent,_that.detail,_that.downloadPercent,_that.downloadedBytes,_that.totalBytes,_that.bytesPerSecond,_that.elapsedSeconds,_that.progressIndeterminate,_that.minimized);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( RemoteSetupPrompt? prompt,  bool inProgress,  String progress,  int percent,  String detail,  int? downloadPercent,  int? downloadedBytes,  int? totalBytes,  int? bytesPerSecond,  int? elapsedSeconds,  bool progressIndeterminate,  bool minimized)?  $default,) {final _that = this;
switch (_that) {
case _AgentSetupState() when $default != null:
return $default(_that.prompt,_that.inProgress,_that.progress,_that.percent,_that.detail,_that.downloadPercent,_that.downloadedBytes,_that.totalBytes,_that.bytesPerSecond,_that.elapsedSeconds,_that.progressIndeterminate,_that.minimized);case _:
  return null;
...
class _AgentSetupState implements AgentSetupState {
  const _AgentSetupState({this.prompt, this.inProgress = false, this.progress = '', this.percent = 0, this.detail = '', this.downloadPercent, this.downloadedBytes, this.totalBytes, this.bytesPerSecond, this.elapsedSeconds, this.progressIndeterminate = false, this.minimized = false});
...
@override@JsonKey() final  bool progressIndeterminate;
...
/// Create a copy of AgentSetupState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? prompt = freezed,Object? inProgress = null,Object? progress = null,Object? percent = null,Object? detail = null,Object? downloadPercent = freezed,Object? downloadedBytes = freezed,Object? totalBytes = freezed,Object? bytesPerSecond = freezed,Object? elapsedSeconds = freezed,Object? progressIndeterminate = null,Object? minimized = null,}) {
...
as int?,setupDownloadedBytes: freezed == setupDownloadedBytes ? _self.setupDownloadedBytes : setupDownloadedBytes // ignore: cast_nullable_to_non_nullable
as int?,setupTotalBytes: freezed == setupTotalBytes ? _self.setupTotalBytes : setupTotalBytes // ignore: cast_nullable_to_non_nullable
as int?,setupBytesPerSecond: freezed == setupBytesPerSecond ? _self.setupBytesPerSecond : setupBytesPerSecond // ignore: cast_nullable_to_non_nullable
as int?,setupElapsedSeconds: freezed == setupElapsedSeconds ? _self.setupElapsedSeconds : setupElapsedSeconds // ignore: cast_nullable_to_non_nullable
as int?,setupProgressIndeterminate: null == setupProgressIndeterminate ? _self.setupProgressIndeterminate : setupProgressIndeterminate // ignore: cast_nullable_to_non_nullable
as bool,agentSetupStates: null == agentSetupStates ? _self.agentSetupStates : agentSetupStates // ignore: cast_nullable_to_non_nullable
...
as String?,codexVersions: null == codexVersions ? _self.codexVersions : codexVersions // ignore: cast_nullable_to_non_nullable
as List<String>,codexVersionsLoading: null == codexVersionsLoading ? _self.codexVersionsLoading : codexVersionsLoading // ignore: cast_nullable_to_non_nullable
as bool,codexVersionsError: freezed == codexVersionsError ? _self.codexVersionsError : codexVersionsError // ignore: cast_nullable_to_non_nullable
as String?,
  ));
}
/// Create a copy of AppUiState
...
@override final  int? setupDownloadedBytes;
@override final  int? setupTotalBytes;
@override final  int? setupBytesPerSecond;
@override final  int? setupElapsedSeconds;
@override@JsonKey() final  bool setupProgressIndeterminate;
...
@override final  String? diagnostic;
 final  List<String> _codexVersions;
@override@JsonKey() List<String> get codexVersions {
  if (_codexVersions is EqualUnmodifiableListView) return _codexVersions;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableListView(_codexVersions);
}

@override@JsonKey() final  bool codexVersionsLoading;
@override final  String? codexVersionsError;
...
as int?,setupElapsedSeconds: freezed == setupElapsedSeconds ? _self.setupElapsedSeconds : setupElapsedSeconds // ignore: cast_nullable_to_non_nullable
as int?,setupProgressIndeterminate: null == setupProgressIndeterminate ? _self.setupProgressIndeterminate : setupProgressIndeterminate // ignore: cast_nullable_to_non_nullable
as bool,agentSetupStates: null == agentSetupStates ? _self._agentSetupStates : agentSetupStates // ignore: cast_nullable_to_non_nullable
...
as TokenUsage?,error: freezed == error ? _self.error : error // ignore: cast_nullable_to_non_nullable
as String?,diagnostic: freezed == diagnostic ? _self.diagnostic : diagnostic // ignore: cast_nullable_to_non_nullable
as String?,codexVersions: null == codexVersions ? _self._codexVersions : codexVersions // ignore: cast_nullable_to_non_nullable
as List<String>,codexVersionsLoading: null == codexVersionsLoading ? _self.codexVersionsLoading : codexVersionsLoading // ignore: cast_nullable_to_non_nullable
as bool,codexVersionsError: freezed == codexVersionsError ? _self.codexVersionsError : codexVersionsError // ignore: cast_nullable_to_non_nullable
as String?,
  ));
